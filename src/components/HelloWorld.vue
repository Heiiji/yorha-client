    ...
    <v-layout row wrap>
      ...
      <v-flex xs8>
        ...
        <v-card dark style="color: black; text-align: left; padding: 20px;" color="white">
          <v-card-text class="px-0"><strong>Datacenter Burning :</strong> Data 4 a bruler dans un grand feu de joie. L'équipe à cependant super bien géré la période de crise. </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs4>
        <v-card dark color="primary">
