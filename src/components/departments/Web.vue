          ...
          <div class="row">
              <div class="col-md-3 profile-image">
                  <div class="profile-image-container">
                      <img src="https://a.fsdn.com/con/app/proj/matrixgl/screenshots/217756.jpg" alt="">
                  </div>
              </div>
          </div>
      </div>
      <div id="main-wrapper">
          <div class="row">
              <div class="col-md-3 user-profile">
                  <h3 class="text-center">Le Web</h3>
                  <p class="text-center">We are the web.</p>
                  <hr>
                  <div class="panel panel-white">
                      <div class="panel-heading">
                          <div class="panel-title">The hacker : </div>
                      </div>
              ...
              <div class="col-md-6 m-t-lg">
                    <div class="profile-timeline">
                            <ul class="list-unstyled">
                                <li v-for="item in allNews" v-if="item.department === 'Web'" :key="item._id" class="timeline-item" style="display: block;">
                                    <div class="panel panel-white">
                                        <div class="panel-body">
              ...
              <div class="col-md-3 m-t-lg">
                <div class="panel panel-white">
                  <v-btn v-if="$store.state.user.local.work === 'Web' && $store.state.user.local.qualifier === 'SquadLeader'" @click="NewDescription = description; EditDescription = true;" color="primary" style="float: right;" fab small dark>
                    <v-icon>edit</v-icon>
                  </v-btn>
                    <div class="panel-heading">
...
export default {
  ...
  methods: {
    GetByDep () {
      var vue = this
      AccountService.FindByDep('Web').then((response) => {
    ...
    GetDep () {
      ...
      this.firebaseApp.auth().currentUser.getIdToken(true).then(function (idToken) {
        DepService.fetchDep(idToken, 'Web').then((response) => {
